# edmini — Development Journal (archive)

> Earlier narrative/publication-style entries, moved verbatim from `PROJECT_JOURNAL.md` on
> 2026-06-19 when the journal switched to a pragmatic/factual style. Kept as-is — the prose is
> usable long-form content. New entries go in `PROJECT_JOURNAL.md`.
